...
{
    [CustomEditor(typeof(ColorTargetText))]
    [CanEditMultipleObjects]
    public class ColorTargetTextEditor : BaseEditor
    {
        protected override ColorName ComponentColorName { get { return DGUI.Colors.ThemesColorName; } }

        private ColorTargetText m_target;

        private ColorTargetText Target
        {
            get
            {
...
//        private Color[] Colors;
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawHeader(Styles.GetStyle(Styles.StyleName.ComponentHeaderColorTargetText), MenuUtils.ColorTargetText_Manual, MenuUtils.ColorTargetText_YouTube);
            GUILayout.Space(DGUI.Properties.Space(2));
            DGUI.Property.Draw(m_text, UILabels.Text, HasReference ? ComponentColorName : ColorName.Red);
            GUILayout.Space(DGUI.Properties.Space());
            ThemeTargetEditorUtils.DrawOverrideAlpha(m_overrideAlpha, m_alpha, Target.Text == null ? 1 : Target.Text.color.a, ComponentColorName, InitialGUIColor);
