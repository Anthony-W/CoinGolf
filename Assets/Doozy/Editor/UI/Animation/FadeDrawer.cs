...
namespace Doozy.Editor.UI.Animation
{
    ...
    {
        private static DColor DrawerColor { get { return EditorColors.Instance.Purple; } }
        private static GUIStyle DrawerIconStyle { get { return Styles.GetStyle(Styles.StyleName.IconFade); } }
        ...
        private void Init(SerializedProperty property)
        {
            ...
            Elements.Add(Properties.Add(PropertyName.From, property), Contents.Add(UILabels.FadeFrom));
            Elements.Add(Properties.Add(PropertyName.To, property), Contents.Add(UILabels.FadeTo));
            Elements.Add(Properties.Add(PropertyName.By, property), Contents.Add(UILabels.FadeBy));
        ...
        protected override void DrawPunch(Rect position, SerializedProperty property, DColor dColor) { DrawUndefined(position, property); }
