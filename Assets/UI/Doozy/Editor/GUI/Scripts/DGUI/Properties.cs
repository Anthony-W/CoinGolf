...
namespace Doozy.Editor
{
    public static partial class DGUI
    {
        public static class Properties
        {
            ...
            public static GUIStyle White { get { return s_white ?? (s_white = new GUIStyle {normal = {background = WhiteTexture}}); } }
            ...
            public static float StandardWindowTabHeight { get { return WINDOW_WINDOW_TAB_HEIGHT; } }
            ...
            public static float StandardHorizontalSpacing { get { return EditorGUIUtility.standardVerticalSpacing * 2; } }
            public static float DefaultFieldWidth { get { return 40; } }

            public static int HotControlId { get { return GUIUtility.hotControl; } }
            public static int KeyboardControlId { get { return GUIUtility.keyboardControl; } }
            public static void ExitGUI() { GUIUtility.ExitGUI(); }

            public static float Space(float multiplier = 1) { return StandardVerticalSpacing * multiplier; }
            ...
            public static void ResetKeyboardFocus() { GUIUtility.keyboardControl = 0; }

            public static float TextIconAlphaValue(bool enabled, bool ignoreAlpha = false) { return (enabled ? 1f : 0.7f) * (ignoreAlpha ? 1f : GUI.color.a); }

            public static UILanguagePack Labels { get { return UILanguagePack.Instance; } }
