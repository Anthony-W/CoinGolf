...
namespace Doozy.Engine.Themes
{
    /// <inheritdoc />
    /// <summary>
    /// Used by the Theme Manager to update the color value of an Image component
    /// </summary>
    [AddComponentMenu(MenuUtils.ColorTargetImage_AddComponentMenu_MenuName, MenuUtils.ColorTargetImage_AddComponentMenu_Order)]
...
#if UNITY_EDITOR
        [MenuItem(MenuUtils.ColorTargetImage_MenuItem_ItemName, false, MenuUtils.ColorTargetImage_MenuItem_Priority)]
        private static void CreateComponent(MenuCommand menuCommand) { DoozyUtils.AddToScene<ColorTargetImage>(MenuUtils.ColorTargetImage_GameObject_Name, false, true); }
#endif
