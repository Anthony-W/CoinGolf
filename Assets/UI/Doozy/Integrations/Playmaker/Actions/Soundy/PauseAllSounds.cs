...
namespace Doozy.Integrations.Playmaker
{
    ...
    [Tooltip("Pause all sound sources managed by Soundy (including MasterAudio)")]
    public class PauseAllSounds : FsmStateAction
    {
        ...
        {
            if (DebugMode.Value) DDebug.Log("Playmaker - State Name [" + State.Name + "] - Pause All Sounds");
